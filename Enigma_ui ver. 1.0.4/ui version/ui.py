...
#
# Created: Fri Jun 12 11:17:32 2020
...
"font-size: 13px;")
        ...
        self.pushButton.setGeometry(QtCore.QRect(250, 40, 131, 41))
        self.pushButton.setStyleSheet("border: 0;\n"
"border-radius: 15px;\n"
"background-color: #fefefe;")
        self.pushButton.setObjectName("pushButton")
        self.lineEdit_2 = QtWidgets.QLineEdit(Dialog)
        self.lineEdit_2.setGeometry(QtCore.QRect(250, 100, 31, 31))
        self.lineEdit_2.setStyleSheet("text-align: center; border: 0; background-color: #fefefe;vertical-align: middle;")
        self.lineEdit_2.setInputMask("")
        self.lineEdit_2.setAlignment(QtCore.Qt.AlignCenter)
        self.lineEdit_2.setObjectName("lineEdit_2")
        self.lineEdit_4 = QtWidgets.QLineEdit(Dialog)
        self.lineEdit_4.setGeometry(QtCore.QRect(300, 100, 31, 31))
        self.lineEdit_4.setStyleSheet("text-align: center; border: 0; background-color: #fefefe;vertical-align: middle;")
        self.lineEdit_4.setAlignment(QtCore.Qt.AlignCenter)
        self.lineEdit_4.setObjectName("lineEdit_4")
        self.lineEdit_5 = QtWidgets.QLineEdit(Dialog)
        self.lineEdit_5.setGeometry(QtCore.QRect(350, 100, 31, 31))
        self.lineEdit_5.setStyleSheet("text-align: center; border: 0; background-color: #fefefe;vertical-align: middle;")
        self.lineEdit_5.setAlignment(QtCore.Qt.AlignCenter)
        self.lineEdit_5.setObjectName("lineEdit_5")
        self.pushButton_2 = QtWidgets.QPushButton(Dialog)
        self.pushButton_2.setGeometry(QtCore.QRect(250, 150, 131, 41))
        self.pushButton_2.setStyleSheet("border: 0;\n"
"border-radius: 15px;\n"
"background-color: #fefefe;")
        self.pushButton_2.setObjectName("pushButton_2")
        self.pushButton_3 = QtWidgets.QPushButton(Dialog)
        self.pushButton_3.setGeometry(QtCore.QRect(250, 210, 131, 41))
        self.pushButton_3.setStyleSheet("border: 0;\n"
"border-radius: 15px;\n"
"background-color: #fefefe;")
        self.pushButton_3.setObjectName("pushButton_3")
        self.textEdit = QtWidgets.QTextEdit(Dialog)
        self.textEdit.setGeometry(QtCore.QRect(20, 30, 211, 291))
        self.textEdit.setStyleSheet("border-radius: 5px; background-color: #fefefe;vertical-align: top;")
        ...
        self.textEdit_2.setStyleSheet("border-radius: 5px; background-color: #fefefe;vertical-align: top;")
        self.textEdit_2.setObjectName("textEdit_2")
        self.pushButton_4 = QtWidgets.QPushButton(Dialog)
        self.pushButton_4.setGeometry(QtCore.QRect(250, 270, 131, 41))
        self.pushButton_4.setStyleSheet("border: 0;\n"
"border-radius: 15px;\n"
"background-color: #fefefe;")
        self.pushButton_4.setObjectName("pushButton_4")
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(240, 10, 151, 21))
